...
const variants= {
  ...
  "tertiary-fill":    "text-base bg-white flex justify-start items-center w-full text-nowrap  gap-3 items-center hover:text-shadow-sm justify-center hover:cursor-pointer transition group rounded-lg",
